--select object_name(1548076801)
SELECT  L.request_session_id AS SPID, 
        DB_NAME(L.resource_database_id) AS DatabaseName,
        case when rtrim(L.resource_type) = 'OBJECT' then object_name(l.resource_associated_entity_id) else O.Name end AS LockedObjectName, 
